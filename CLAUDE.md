# complex-clause-plugin

complex-clause-plugin subproject. Komet plugin for Layer-2 / computable-logic complex-concept clauses (supra-DL) that exceed OWL EL++, explicated to CQL (ike-issues#628).
...
See `CLAUDE-complex-clause-plugin.md` for project-specific notes.
